                           ...
                           <div class="mb-10" id="kt_social_feeds_posts">
                               ...
                               <div class="card card-flush mb-10">
                                   ...
                                   <div class="card-header pt-9">
                                       ...
                                       <div class="d-flex align-items-center">
                                           ...
                                           <div class="flex-grow-1">
                                               <!--begin::Name-->
                                               <a href="#"
                                                   class="text-gray-800 text-hover-primary fs-4 fw-bold">Grace
                                                   Logan</a>
                                               <!--end::Name-->
                                               <!--begin::Date-->
                                   ...
                                   <div class="card-body">
                                       <!--begin::Post content-->
                                       <div class="fs-6 fw-normal text-gray-700 mb-5">There are two main approaches
                                           you can take to writing amazing blog post headlines. You can either decide
                                           on your final headline before outstanding you write the most of the rest of
                                           your creative post</div>
                                       <!--end::Post content-->
                                       <!--begin::Post media-->
                                           ...
                                           <div class="collapse show" id="kt_social_feeds_comments_1">
                                               ...
                                               <div class="d-flex pt-6">
                                                   ...
                                                   <div class="d-flex flex-column flex-row-fluid">
                                                       ...
                                                       <!--end::Info-->
                                                       <!--begin::Text-->
                                                       <span class="text-gray-800 fs-7 fw-normal pt-1">Long before you
                                                           sit dow to put digital pen to paper you need to make sure
                                               ...
                                               <div class="d-flex pt-6">
                                                   ...
                                                   <div class="d-flex flex-column flex-row-fluid">
                                                       ...
                                                       <!--begin::Text-->
                                                       <span class="text-gray-800 fs-7 fw-normal pt-1">Long before you
                                                           sit dow to put digital pen to paper</span>
                                                       <!--end::Text-->
                                                   </div>
                                                   <!--end::Wrapper-->
                                               </div>
                               ...
                               <div class="card card-flush mb-10">
                                   ...
                                   <div class="card-header pt-9">
                                       ...
                                       <div class="d-flex align-items-center">
                                           ...
                                           <div class="flex-grow-1">
                                               <!--begin::Name-->
                                               <a href="#"
                                                   class="text-gray-800 text-hover-primary fs-4 fw-bold">Brooklyn
                                                   Simmons</a>
                                               <!--end::Name-->
                                               <!--begin::Date-->
                                               <span class="text-gray-400 fw-semibold d-block">Yestarday at 5:06
                                   ...
                                   <div class="card-body">
                                       <!--begin::Post content-->
                                       <div class="fs-6 fw-normal text-gray-700">You can either decide on your final
                                           headline before outstanding you write the most of the rest of your creative
                                           post</div>
                                       <!--end::Post content-->
                                   </div>
                                   <!--end::Card body-->
                               ...
                               <div class="card card-flush mb-10">
                                   ...
                                   <div class="card-header pt-9">
                                       ...
                                       <div class="d-flex align-items-center">
                                           ...
                                           <div class="flex-grow-1">
                                               <!--begin::Name-->
                                               <a href="#"
                                                   class="text-gray-800 text-hover-primary fs-4 fw-bold">Finance Deprt
                                                   - Annual Report</a>
                                               <!--end::Name-->
                                               <!--begin::Date-->
                                               <span class="text-gray-400 fw-semibold d-block">Yestarday at 5:06
                                   ...
                                   <div class="card-body">
                                       <!--begin::Post content-->
                                       <div class="fs-6 fw-normal text-gray-700 mb-5">You can either decide on your
                                           final headline before outstanding you write the most of the rest of your
                                           creative post</div>
                                       <!--end::Post content-->
                                       <!--begin::Video-->
                                       <div class="m-0">
                                   ...
                                   <div class="card-header pt-9">
                                       ...
                                       <div class="d-flex align-items-center">
                                           ...
                                           <div class="flex-grow-1">
                                               <!--begin::Name-->
                                               <a href="#"
                                                   class="text-gray-800 text-hover-primary fs-4 fw-bold">Ana Lee</a>
                                               <!--end::Name-->
                                               <!--begin::Date-->
                                               <span class="text-gray-400 fw-semibold d-block">Yestarday at 5:06
                                                   PM</span>
                               ...
                               <div class="d-none" id="kt_social_feeds_more_posts">
                                   ...
                                   <div class="card card-flush mb-10">
                                       ...
                                       <div class="card-header pt-9">
                                           ...
                                           <div class="d-flex align-items-center">
                                               ...
                                               <div class="flex-grow-1">
                                                   ...
                                                   <!--end::Name-->
                                                   <!--begin::Date-->
                                                   <span class="text-gray-400 fw-semibold d-block">Yestarday at 3:30
                                                       PM</span>
                                                   <!--end::Date-->
                                               </div>
                                               <!--end::Info-->
                                       ...
                                       <div class="card-body">
                                           <!--begin::Post content-->
                                           <div class="fs-6 fw-normal text-gray-700 mb-5">You can either decide on
                                               your final headline before outstanding.</div>
                                           <!--end::Post content-->
                                           <!--begin::Post media-->
                                               ...
                                               <div class="collapse" id="kt_social_feeds_comments_5">
                                                   ...
                                                   <div class="d-flex pt-6">
                                                       ...
                                                       <div class="d-flex flex-column flex-row-fluid">
                                                           ...
                                                           <span class="text-gray-800 fs-7 fw-normal pt-1">Long
                                                               before you sit dow to put digital pen to paper you need
                                                   ...
                                                   <div class="d-flex pt-6">
                                                       ...
                                                       <div class="d-flex flex-column flex-row-fluid">
                                                           ...
                                                           <!--begin::Text-->
                                                           <span class="text-gray-800 fs-7 fw-normal pt-1">Long
                                                               before you sit dow to put digital pen to paper</span>
                                                           <!--end::Text-->
                                                       </div>
                                                       <!--end::Wrapper-->
                                                   </div>
                                   ...
                                   <div class="card card-flush mb-10">
                                       ...
                                       <div class="card-header pt-9">
                                           ...
                                           <div class="d-flex align-items-center">
                                               ...
                                               <div class="flex-grow-1">
                                                   ...
                                                   <!--end::Name-->
                                                   <!--begin::Date-->
                                                   <span class="text-gray-400 fw-semibold d-block">Yestarday at 10:10
                                                       AM</span>
                                                   <!--end::Date-->
                                               </div>
                                               <!--end::Info-->
                                       ...
                                       <div class="card-body">
                                           <!--begin::Post content-->
                                           <div class="fs-6 fw-normal text-gray-700">You can either decide on your
                                               final headline before outstanding you write the most of the rest of your
                                               creative post</div>
                                           <!--end::Post content-->
                                       </div>
                               ...
                               <div class="card card-flush mb-10">
                                   ...
                                   <div class="card-body">
                                       ...
                                       <div class="fs-6 fw-normal text-gray-700" data-kt-post-element="content">You
                                           can either decide on your final headline before outstanding you write the
                                           most of the rest of your creative post</div>
                                       <!--end::Post content-->
                                   </div>
                                   <!--end::Card body-->
                                   <!--begin::Card footer-->
